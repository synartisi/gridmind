...
class MindMapApp(App):
    ...
    def start_mapping(self):        # mindmap process
        """매핑 시작"""
    ...
    def start_next_parent(self):
        ...
        self.remaining_children = [w for idx, w in list(enumerate(self.const_spl)) if w != self.current_parent and idx > self.current_index]
        self.current_child_index = 0
